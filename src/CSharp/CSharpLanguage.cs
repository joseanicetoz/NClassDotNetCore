...
namespace NClass.CSharp
{
    ...
    {
        static readonly CSharpLanguage instance = new CSharpLanguage();
        ...
        static readonly Regex nameRegex = new Regex(ClosedNamePattern, RegexOptions.ExplicitCapture);
        static readonly Regex genericNameRegex = new Regex(ClosedGenericNamePattern, RegexOptions.ExplicitCapture);
        static readonly Regex typeRegex = new Regex(ClosedTypePattern, RegexOptions.ExplicitCapture);
        ...
        static readonly CSharpClass objectClass;
