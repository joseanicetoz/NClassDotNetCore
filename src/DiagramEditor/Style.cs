...
public sealed class Style : IDisposable
{
    ...
    private static readonly string stylesDir = Path.Combine(settingsDir, "UserStyles");
    ...
    private int classRoundingSize = 0;
    private bool isClassBorderDashed = false;
    ...
    private bool isAbstractClassBorderDashed = false;
    private bool isSealedClassBorderDashed = false;
    private bool isStaticClassBorderDashed = false;

    // Structure fields
    private int structureBorderWidth = 1;
    private int structureRoundingSize = 0;
    private bool isStructureBorderDashed = false;
    ...
    private int interfaceRoundingSize = 0;
    private bool isInterfaceBorderDashed = false;
    ...
    private int enumRoundingSize = 0;
    private bool isEnumBorderDashed = false;
    ...
    private int delegateRoundingSize = 0;
    private bool isDelegateBorderDashed = false;
    ...
    private bool isCommentBorderDashed = false;
    ...
    private static Style Load(string path, bool addToList)
    {
        try
        {
            ...
            Style result = JsonSerializer.Deserialize<Style>(data);
