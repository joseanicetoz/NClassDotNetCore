...
namespace NClass.DiagramEditor
{
    ...
    public sealed class Style : IDisposable
    {
        ...
        static readonly SortedList<string, Style> styles = new SortedList<string, Style>();
        ...
        static readonly string stylesDir = Path.Combine(settingsDir, "UserStyles");
        static readonly string userStylePath = Path.Combine(settingsDir, "style.dst");
