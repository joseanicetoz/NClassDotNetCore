...
public class Diagram : Model, IDocument, IEditable, IPrintable
{
    ...
    private ElementList<Shape> shapes = new ElementList<Shape>();
    private ElementList<Connection> connections = new ElementList<Connection>();
    ...
    private int selectedConnectionCount = 0;
    ...
    {
        get { return shapes; }
        set { shapes = (ElementList<Shape>)value; }
    }
    ...
    public IEnumerable<Connection> Connections
    {
        ...
        set { connections = (ElementList<Connection>)value; }
    }
    ...
    public Color BackColor
    {
        ...
        set { Style.CurrentStyle.BackgroundColor = value; }
    }
    ...
    public bool RedrawSuspended
    {
        ...
        set
        {
            if (redrawSuspended == value) return;
            
            redrawSuspended = value;
            if (redrawSuspended) return;
    ...
    {
        if (!HasSelectedElement || SelectedElementCount != 1) return null;
