...
namespace NClass.DiagramEditor.ClassDiagram.Shapes
{
    public abstract class TypeShape : Shape
    {
        ...
        static readonly Pen borderPen = new Pen(Color.Black);
        static readonly SolidBrush backgroundBrush = new SolidBrush(Color.White);
        static readonly SolidBrush solidHeaderBrush = new SolidBrush(Color.White);
        static readonly SolidBrush nameBrush = new SolidBrush(Color.Black);
        static readonly SolidBrush identifierBrush = new SolidBrush(Color.Black);
        static readonly StringFormat headerFormat = new StringFormat(StringFormat.GenericTypographic);
