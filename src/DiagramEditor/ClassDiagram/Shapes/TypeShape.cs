...
public abstract class TypeShape : Shape
{
    ...
    private bool showChevron = false;
    private EditorWindow showedEditor = null;
    ...
    {
        get { return new(Left + MarginSize, Top + MarginSize, Width - MarginSize * 2, HeaderHeight - MarginSize * 2); }
        set => throw new NotImplementedException();
    }
    ...
    {
        get { return new(DefaultWidth, DefaultHeight); }
    }
