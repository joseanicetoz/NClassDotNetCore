...
namespace NClass.DiagramEditor.ClassDiagram.Shapes
{
    ...
    {
        static readonly DelegateEditor typeEditor = new DelegateEditor();
        static readonly ParameterEditor parameterEditor = new ParameterEditor();
        static readonly DelegateDialog delegateDialog = new DelegateDialog();
        static readonly SolidBrush parameterBrush = new SolidBrush(Color.Black);
        readonly DelegateType _delegate;
