...
namespace NClass.DiagramEditor.ClassDiagram.Shapes
{
    public abstract class CompositeTypeShape : TypeShape
    {
        ...
        static readonly CompositeTypeEditor typeEditor = new CompositeTypeEditor();
        static readonly MemberEditor memberEditor = new MemberEditor();
        static readonly MembersDialog membersDialog = new MembersDialog();
        static readonly SolidBrush memberBrush = new SolidBrush(Color.Black);
        static readonly StringFormat accessFormat = new StringFormat(StringFormat.GenericTypographic);
        static readonly Pen selectionPen = new Pen(Color.Black);
