...
{
    private static readonly TypeShapeContextMenu _default = new TypeShapeContextMenu();

    private ToolStripMenuItem mnuSize, mnuAutoSize, mnuAutoWidth, mnuAutoHeight;
    private ToolStripMenuItem mnuCollapseAllSelected, mnuExpandAllSelected;
