...
{
    private static readonly ShapeContextMenu _default = new ShapeContextMenu();

    private ToolStripMenuItem mnuAlign;
    private ToolStripMenuItem mnuAlignTop, mnuAlignLeft, mnuAlignBottom, mnuAlignRight;
    private ToolStripMenuItem mnuAlignHorizontal, mnuAlignVertical;
    private ToolStripMenuItem mnuMakeSameSize;
    private ToolStripMenuItem mnuSameWidth, mnuSameHeight, mnuSameSize;
