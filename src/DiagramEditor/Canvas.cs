...
public partial class Canvas : UserControl, IDocumentVisualizer
{
    ...
    public Rectangle VisibleArea
    {
        ...
        {
            if (HasDocument)
                return new Rectangle((int)(Document.Offset.X / Document.Zoom), (int)(Document.Offset.Y / Document.Zoom), (int)(this.ClientSize.Width / Document.Zoom), (int)(this.ClientSize.Height / Document.Zoom));
